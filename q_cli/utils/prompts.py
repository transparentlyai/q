...
def get_prompt(file_path: str, **kwargs: Any) -> str:
    ...
    # No default values should be added here
                ...
                with open(CONFIG_PATH, "r") as f:
                    ...
                    for i, line in enumerate(lines):
                        if '#CONTEXT' in line and i+1 < len(lines):
                            ...
                            break
                    if context_section:
                        print(f"Q.conf #CONTEXT section (first 10 lines):\n{context_section}")
    ...
    if get_debug() and result:
        ...
        if 'usercontext' in kwargs or 'projectcontext' in kwargs:
            ...
            print(f"Final project context in prompt: {project_context_content or '(empty)'}")
...
def get_system_prompt(
    ...
    system_prompt = get_prompt(prompt_path, model=model or "", usercontext=usercontext, projectcontext=projectcontext)
