    ...
    for marker, url, position, _ in sorted(
        ...
        try:
            ...
            try:    
                ...
                model_url_content[url] = "STOP. The operation was cancelled by user. Do not proceed with any additional commands or operations. Wait for new instructions from the user."
